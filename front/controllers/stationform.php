 ...
 */
class BtsControllerStationForm extends BtsController
{
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('StationForm', 'BtsModel');
		...
		$this->setRedirect(JRoute::_('index.php?option=com_bts&view=station&layout=edit', false));
	}
	...
	public function save()
	{
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_bts&view=stationform&layout=edit&id='.$id, false));
			return false;
		}

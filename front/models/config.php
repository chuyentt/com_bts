 ...
 * Bts model.
 */
class BtsModelConfig extends JModelForm
{
	...
	protected function populateState()
	{
        ...
        if (JFactory::getApplication()->input->get('layout') == 'edit') {
            $id = JFactory::getApplication()->getUserState('com_bts.edit.config.id');
        } else {
            $id = JFactory::getApplication()->input->get('id');
            JFactory::getApplication()->setUserState('com_bts.edit.config.id', $id);
        }
        ...
        if(isset($params_array['item_id'])){
            $this->setState('config.id', $params_array['item_id']);
        }
	...
	public function getTable($type = 'Config', $prefix = 'BtsTable', $config = array())
	{   
	...
	{
		// Get the id.
		$id = (!empty($id)) ? $id : (int)$this->getState('config.id');
	...
	{
		// Get the form.
		$form = $this->loadForm('com_bts.config', 'config', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}

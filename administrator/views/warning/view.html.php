 ...
 * View to edit
 */
class BtsViewWarning extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BTS_TITLE_WARNING'), 'warning.png');
		...
		if (!$isNew && $canDo->get('core.create')) {
			JToolBarHelper::custom('warning.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}
		if (empty($this->item->id)) {
			JToolBarHelper::cancel('warning.cancel', 'JTOOLBAR_CANCEL');
		}
		else {

 ...
 */
class BtsViewConfigs extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BTS_TITLE_CONFIGS'), 'configs.png');
...
*/
		...
		JHtmlSidebar::setAction('index.php?option=com_bts&view=configs');
	...
	protected function getSortFields()
	{
		...
		'a.field' => JText::_('COM_BTS_CONFIGS_FIELD'),
		'a.label' => JText::_('COM_BTS_CONFIGS_LABEL'),
		'a.displayable' => JText::_('COM_BTS_CONFIGS_DISPLAYABLE'),
		'a.editable' => JText::_('COM_BTS_CONFIGS_EDITABLE'),
		);
	}

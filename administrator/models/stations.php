...
class BtsModelStations extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'combine', 'a.combine',
                'typestation', 'a.typestation',
                'indoormaintenance', 'a.indoormaintenance',
                'outdoormaintenance', 'a.outdoormaintenance',
                'maintenanceby', 'a.maintenanceby',
                'manager', 'a.manager',
                'mobile', 'a.mobile',
                'project', 'a.project',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.bts_name', 'asc');
    }
    ...
    if (is_numeric($published)) {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.bts_name LIKE '.$search.'  OR  a.address LIKE '.$search.' OR  a.bsc_name LIKE '.$search.' )');
            }
        }

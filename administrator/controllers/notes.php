 ...
 */
class BtsControllerNotes extends JControllerAdmin
{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'note', $prefix = 'BtsModel')
	{
	...
	public function approve()
	{
		...
		$this->setRedirect('index.php?option=com_bts&view=notes');
	}

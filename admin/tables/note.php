 ...
 * note Table class
 */
class BtsTablenote extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__bts_note', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
		...
		if(($task == 'apply' || $task == 'save') && (isset($array['approved']) && $array['approved'] == 1)){
        ...
        if(!JFactory::getUser()->authorise('core.admin', 'com_bts.note.'.$array['id'])){
            $actions = JFactory::getACL()->getActions('com_bts','note');
            $default_actions = JFactory::getACL()->getAssetRules('com_bts.note.'.$array['id'])->getData();
            $array_jaccess = array();
    ...
    */
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_bts.note.' . (int) $this->$k;
    }

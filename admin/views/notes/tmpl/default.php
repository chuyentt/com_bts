...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_bts&task=notes.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'noteList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_bts&view=notes'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="noteList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BTS_NOTES_APPROVED_BY', 'a.approved_by', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_BTS_NOTES_APPROVED_TIME', 'a.approved_time', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_bts&task=note.edit&id='.(int) $item->id); ?>">

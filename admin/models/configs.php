 ...
 */
class BtsModelConfigs extends JModelList {
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.field', 'asc');
    }
    ...
    if (is_numeric($published)) {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.field LIKE '.$search.'  OR  a.label LIKE '.$search.' )');
            }
        }
